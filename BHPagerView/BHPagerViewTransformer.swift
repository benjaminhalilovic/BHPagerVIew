...
open class BHPagerViewTransformer: NSObject {
    open internal(set) weak var pagerView: BHPagerView?
    ...
    open func applyTransform(to attributes: BHPagerViewLayoutAttributes) {
